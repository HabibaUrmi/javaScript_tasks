...
let attendes = ["John", "Sarah", "John", "Alex", "John"];
...
let johnIndices = attendees
  .map((name, index) => (name === "John" ? index : -1))
  .filter((index) => index !== -1);
console.log(johnIndices); // [0, 2, 4]
...
birdSpecies.shift(); // Removes first element
birdSpecies.pop(); // Removes last element
