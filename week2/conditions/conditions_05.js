...
console.log(checkAnimal("fox")); // Output: "You have a clever companion!"
console.log(checkAnimal("cat")); // Output: "Not a fox, but still cool!"
console.log(checkAnimal("dog")); // Output: "Not a fox, but still cool!"
