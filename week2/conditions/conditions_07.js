...
console.log(getAnimalDescription("fox")); // Output: "Foxes are sly and smart!"
console.log(getAnimalDescription("dog")); // Output: "Dogs are loyal friends."
console.log(getAnimalDescription("cat")); // Output: "Cats are curious and independent."
console.log(getAnimalDescription("lion")); // Output: "All animals are awesome!"
