...
// Your code here
function Book(tittle, author, yearPublished, genres) {
  this.tittle = tittle;
  this.author = author;
...
// Your code here
function createBook(tittle, author, yearPublished, genres) {
  const book = new Book(title, author, yearPublished, genres);
  return book;
}

const createdBook = createdBook("different book", "different author", 1960, [
  "Drama",
  "Tragedy",
]);
...
const userProfiles = [
  ...
  { username: "admin2", email: "admin2@example.com", isAdmin: true },
];
